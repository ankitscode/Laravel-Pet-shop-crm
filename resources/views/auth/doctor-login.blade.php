                            ...
                            <div class="card mt-4">
                                ...
                                <div class="card-body p-4">
                                    <div class="text-center mt-2">
                                        ...
                                        <p class="text-muted">Log in As Doctor to continue to YourVet Doc.</p>
                                    </div>
                                    <div class="p-2 mt-4">
                                        <form action='{{route('doctorlogin')}}' method="POST">
                                            ...
                                            <div class="mt-4 text-center">
                                                <p class="mb-0">Don't have an account? <a href="DoctorSignup"
                        ...
                        <div class="col-lg-12">
                            <div class="text-center">
                                <p class="mb-0 text-muted">&copy;
                                    ...
                                    </script>YourVet Doc. <i class="mdi mdi-heart text-danger"></i>
                                </p>
                            </div>
                        </div>
                    </div>
